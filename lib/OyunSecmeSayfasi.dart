...
import 'package:mobilodevi/beyond.dart';
import 'package:mobilodevi/detroit.dart';
import 'package:mobilodevi/gta5.dart';
import 'package:mobilodevi/lis.dart';
import 'package:mobilodevi/tlou.dart';
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => fortinayti()));
                  },
                  ...
                  child: const Text("Fortnite", style: TextStyle(fontSize: 20)),
                ),
                SizedBox(
                  width: 15,
                ),
                Image.asset(height: 75, width: 200, "images/fortinayti.png"),
              ],
            ),
          ),
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Image.asset(height: 75, width: 200, "images/detroit2.png"),
              ],
            ),
          ),
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Image.asset(height: 75, width: 200, "images/beyond.png"),
              ],
            ),
          ),
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Image.asset(height: 75, width: 200, "images/gta5.png"),
              ],
            ),
          ),
          Padding(
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Image.asset(height: 75, width: 200, "images/lis.png"),
              ],
            ),
          ),
          Padding(
              ...
              children: [
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                      ...
                      elevation: 15.0,
                      shadowColor: Color(0xffcae9ea)),
                  child: const Text("Anasayfa", style: TextStyle(fontSize: 15)),
                ),
              ],
            ),
          ),
